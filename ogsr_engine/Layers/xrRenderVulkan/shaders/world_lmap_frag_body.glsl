...
void main()
{
    ...
    if (SPEC_DEBUG && L.pom_params3.y > 0.5) { occ = vec3(1.0); hemiOccL = 1.0; dynHemiL = 1.0; }   // r_ao_flat debug
    ...
    vec3 lighting = skyAmbient(gtaoBentN(Nw)) * (hemiOccL * L.sky_params.y * dynHemiL) * occ
