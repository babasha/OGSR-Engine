...
// World pass — tessellation control, lmap variant (R4 TESS_PN+HM port,
// r3\dx11\tess.hs). Pass-through control points + distance-adaptive edge
// factors + the PN-triangle patch (cubic position / quadratic normal control
// points, tess.h ComputePNPatch). Edge factors are computed symmetrically
// from the two endpoints of each edge, so adjacent patches always agree →
// crack-free borders.
