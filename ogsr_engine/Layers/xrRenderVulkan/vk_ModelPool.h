...
public:
    // Per-level override configs (mirror R4 CModelPool). Shared SkeletonCustom /
    // SkeletonAnimated read these to override userdata / bone defs / motion sets.
    // Null unless a level supplies the override ltx.
