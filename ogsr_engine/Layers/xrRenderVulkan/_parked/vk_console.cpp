...
float ps_r__trail_fade_time = 60.0f;  // Grass trail half-life in seconds
...
// ============================================================================
u32 ps_r__reflex_mode = 0;  // 0=off, 1=on, 2=on+boost
xr_token qreflex_mode_token[] = {
    {"off", 0}, {"on", 1}, {"boost", 2}, {0, 0}
};
...
// ============================================================================
// Sun Cascade Shadow Maps
// ============================================================================
u32 ps_r__sun_shadows = 1;  // 0=off, 1=on (default: on)
xr_token qsun_shadows_token[] = {
    {"off", 0}, {"on", 1}, {0, 0}
};

u32 ps_r__sun_cascades = 4;  // Active cascade count (1-6, default 4)

// ============================================================================
// DLSS Frame Generation (Multi-Frame Generation)
// ============================================================================
u32 ps_r__frame_gen = 0;  // 0=off, 1=on
xr_token qframe_gen_token[] = {
    {"off", 0}, {"on", 1}, {0, 0}
};
...
// ============================================================================
u32   ps_r__rtgi = 0;               // 0=off, 1=on (default: off, expensive)
float ps_r__rtgi_intensity = 1.0f;  // GI intensity multiplier
float ps_r__rtgi_radius = 12.0f;    // Max ray trace distance in meters
u32   ps_r__rtgi_debug = 0;         // 0=normal, 1=force-bright (pipeline test), 2=hit-count viz
...
void xrRender_initconsole()
{
    ...
    CMD4(CCC_Float, "r__trail_fade_time",   &ps_r__trail_fade_time,     10.0f, 600.0f);
    ...
    CMD3(CCC_Token, "r__reflex_mode", &ps_r__reflex_mode, qreflex_mode_token);

    // DLSS Frame Generation
    CMD3(CCC_Token, "r__frame_gen", &ps_r__frame_gen, qframe_gen_token);

    // Sun shadow cascade count (1-6, default 4)
    CMD4(CCC_Integer, "r__sun_cascades", (int*)&ps_r__sun_cascades, 1, 6);

    // RTGI (Ray-Traced Global Illumination) — off by default, expensive
    CMD4(CCC_Integer, "r__rtgi", (int*)&ps_r__rtgi, 0, 1);
    CMD4(CCC_Float, "r__rtgi_intensity", &ps_r__rtgi_intensity, 0.0f, 5.0f);
    CMD4(CCC_Float, "r__rtgi_radius", &ps_r__rtgi_radius, 1.0f, 50.0f);
    CMD4(CCC_Integer, "r__rtgi_debug", (int*)&ps_r__rtgi_debug, 0, 2);
